...
export declare type SliderSingleProps = SliderBaseProps<number>;
export declare type SliderRangeProps = SliderBaseProps<[number, number]>;
export declare type SliderProps = SliderSingleProps | SliderRangeProps;
