...
export declare type NotifyMessage = string | React.ReactNode;
...
export declare type NotifyPrivateProps = {
    /** @private */
    onClosed?: () => void;
};
...
export declare type NotifyMethodProps = string | Omit<NotifyProps, 'visible' | 'type'>;
export declare type NotifyStatic = {
    /** 展示提示	 */
