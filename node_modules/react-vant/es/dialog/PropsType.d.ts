...
export interface DialogProps extends Omit<BaseTypeProps, 'children'> {
    ...
    onClosed?: () => void;
    /** 点击确认的回调 */
    onConfirm?: (e: React.MouseEvent) => void | boolean | Promise<boolean> | Promise<void> | Promise<void | boolean>;
    /** 是否支持点击遮罩关闭对话框 */
    onCancel?: (e: React.MouseEvent) => void | boolean | Promise<boolean> | Promise<void> | Promise<void | boolean>;
}
export declare type AlertDialogProps = Omit<DialogProps, 'confirmButtonText' | 'onCancel'>;
export declare type DialogStatic = {
