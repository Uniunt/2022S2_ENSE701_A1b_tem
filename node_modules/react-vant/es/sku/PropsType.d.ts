...
export declare type SkuTreeItemData = {
    k: string | number;
    v: SkuTreeItemValueData[];
    k_s: string | number;
    is_multiple?: boolean;
};
export declare type SkuTreeItemValueData = {
    id: string | number;
    name: string | number;
    imgUrl?: string;
    img_url?: string;
...
export declare type SkuPropItemData = {
    k: number | string;
...
export declare type SkuPropItemValueData = {
    id: number | string;
    name: string;
    price?: string | number;
};
export declare type SkuListItemData = {
    id: number;
    s1: string;
    s2: string;
    s3: string;
...
export declare type SkuMessageData = {
    name: string;
    type: string;
    required?: string;
    datetime?: string;
...
export declare type SkuGoodsData = {
    title: string;
    picture: string;
};
export declare type SelectedSkuData = Record<string, string>;
export declare type SkuValueType = Record<string | number, (string | number)[]>;
export declare type SkuFieldNames = {
    text?: string;
    value?: string;
    children?: string;
};
export declare type SkuActionType = 'add-cart' | 'buy-clicked';
export declare type SkuStateType = {
...
export declare type SkuInstance = {
    /** 重置Sku到初始状态	 */
    reset: () => void;
    /** 打开Sku，支持设置默认值 */
