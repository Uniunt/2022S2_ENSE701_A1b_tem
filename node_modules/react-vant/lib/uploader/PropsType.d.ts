...
export declare type UploaderValueItem = {
    /** 唯一标识 */
    key?: string | number;
    /** 资源地址 */
    url?: string;
...
declare type TaskStatus = 'pending' | 'failed';
export declare type UploaderTask = {
    id: number;
    url?: string;
    status: TaskStatus;
    file: File;
...
export interface UploaderPrviewItemProps extends Pick<UploaderProps, 'deletable' | 'statusTextRender' | 'name' | 'imageFit' | 'previewSize' | 'deleteRender'> {
    status?: TaskStatus;
    /** 删除文件预览时触发	 */
    onDelete?: () => void;
    onPreview?: () => void;
...
export declare type UploaderInstance = {
