...
} & NativeProps<'--rv-selector-color' | '--rv-selector-checked-color' | '--rv-selector-text-color' | '--rv-selector-checked-text-color' | '--rv-selector-border' | '--rv-selector-checked-border' | '--rv-selector-border-radius' | '--rv-selector-padding' | '--rv-selector-margin'>;
